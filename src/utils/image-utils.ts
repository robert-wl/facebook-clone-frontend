...
export const defaultGroupCover = `${import.meta.env.VITE_ROOT_URL}/group/default-group-cover.png`;
export const defaultGroupBackground = `${import.meta.env.VITE_ROOT_URL}/user/default-profile.jpg`;
export const defaultUserBackground = "https://picsum.photos/200/300";
export const defaultUserProfile = `${import.meta.env.VITE_ROOT_URL}/user/default-profile.jpg`;
