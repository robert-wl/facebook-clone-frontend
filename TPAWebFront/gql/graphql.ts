...
export type Group = {
    ...
    joined: "not joined" | "pending" | "joined" | "not accepted";
...
export type User = {
    ...
    friended: "friends" | "not friends" | "pending";
...
export type GetGroupQuery = {
    ...
    getGroup?: {
        ...
        joined: string;
        memberCount: number;
        posts?: Array<{ __typename?: "Post"; id: string; content: string; privacy: string; likeCount: number; commentCount: number; shareCount: number; liked?: boolean | null; files?: Array<string | null> | null; createdAt: any; user: { __typename?: "User"; firstName: string; lastName: string; username: string; profile?: string | null; email: string; gender: string; dob: any }; comments?: Array<{ __typename?: "Comment"; id: string; content: string } | null> | null } | null> | null;
        members: Array<{ __typename?: "Member"; approved: boolean; role: string; user: { __typename?: "User"; id: string; firstName: string; lastName: string; username: string; profile?: string | null } }>;
        chat?: { __typename?: "Conversation"; id: string } | null;
    } | null;
};
...
export type GetGroupHomePostsQuery = {
    ...
    getGroupHomePosts?: Array<{
        ...
        createdAt: any;
        user: { __typename?: "User"; firstName: string; lastName: string; username: string; profile?: string | null; email: string; gender: string; dob: any };
        postTags?: Array<{ __typename?: "PostTag"; user: { __typename?: "User"; firstName: string; lastName: string } } | null> | null;
        comments?: Array<{ __typename?: "Comment"; id: string; content: string } | null> | null;
    } | null> | null;
};
...
export type GetGroupPostsQuery = {
    __typename?: "Query";
    getGroupPosts?: Array<{ __typename?: "Post"; id: string; content: string; privacy: string; likeCount: number; commentCount: number; shareCount: number; liked?: boolean | null; files?: Array<string | null> | null; createdAt: any; user: { __typename?: "User"; firstName: string; lastName: string; username: string; profile?: string | null; email: string; gender: string; dob: any }; comments?: Array<{ __typename?: "Comment"; id: string; content: string } | null> | null } | null> | null;
};
...
export type GetConversationsQuery = {
    ...
    getConversations?: Array<{
        __typename?: "Conversation";
        id: string;
        users: Array<{ __typename?: "ConversationUsers"; user: { __typename?: "User"; id: string; firstName: string; lastName: string; username: string; profile?: string | null } }>;
        group?: { __typename?: "Group"; name: string; background: string; members: Array<{ __typename?: "Member"; approved: boolean; role: string; user: { __typename?: "User"; firstName: string; lastName: string; username: string } }> } | null;
        messages?: Array<{ __typename?: "Message"; message?: string | null } | null> | null;
    } | null> | null;
};
...
export type CreatePostMutation = {
    ...
    createPost?: {
        ...
        files?: Array<string | null> | null;
        createdAt: any;
        user: { __typename?: "User"; firstName: string; lastName: string; profile?: string | null };
        postTags?: Array<{ __typename?: "PostTag"; user: { __typename?: "User"; firstName: string; lastName: string } } | null> | null;
        comments?: Array<{ __typename?: "Comment"; id: string; content: string } | null> | null;
    } | null;
};
...
export type GetCommentPostQuery = {
    ...
    getCommentPost?: Array<{
        ...
        likeCount: number;
        user: { __typename?: "User"; firstName: string; lastName: string; username: string; profile?: string | null; email: string; gender: string; dob: any };
        comments?: Array<{ __typename?: "Comment"; id: string; content: string; liked?: boolean | null; likeCount: number; user: { __typename?: "User"; firstName: string; lastName: string; username: string; profile?: string | null; email: string; gender: string; dob: any } } | null> | null;
    } | null> | null;
};
...
export type GetReelCommentsQuery = {
    __typename?: "Query";
    getReelComments: Array<{
        __typename?: "ReelComment";
        id: string;
        content: string;
        likeCount: number;
        replyCount: number;
        liked?: boolean | null;
        user: { __typename?: "User"; id: string; firstName: string; lastName: string; username: string; profile?: string | null };
        comments?: Array<{ __typename?: "ReelComment"; id: string; content: string; likeCount: number; replyCount: number; liked?: boolean | null; user: { __typename?: "User"; firstName: string; lastName: string; username: string; profile?: string | null } } | null> | null;
    } | null>;
};
...
export type GetFilteredPostsQuery = {
    __typename?: "Query";
    getFilteredPosts?: Array<{
        __typename?: "Post";
        id: string;
        content: string;
        privacy: string;
...
export type GetUserQuery = {
    ...
    getUser?: {
        ...
        friendCount: number;
        mutualCount: number;
        posts?: Array<{ __typename?: "Post"; id: string; content: string; privacy: string; likeCount: number; commentCount: number; shareCount: number; liked?: boolean | null; files?: Array<string | null> | null; createdAt: any; user: { __typename?: "User"; firstName: string; lastName: string; profile?: string | null } } | null> | null;
    } | null;
};
...
export const AcceptFriendDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "acceptFriend" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "friend" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "acceptFriend" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "friend" }, value: { kind: "Variable", name: { kind: "Name", value: "friend" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "accepted" } }] } }] },
        },
    ],
} as unknown as DocumentNode<AcceptFriendMutation, AcceptFriendMutationVariables>;
    ...
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "addFriend" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "friendInput" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "FriendInput" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "addFriend" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "friendInput" }, value: { kind: "Variable", name: { kind: "Name", value: "friendInput" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "sender" }, selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "username" } }] } },
                                { kind: "Field", name: { kind: "Name", value: "receiver" }, selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "username" } }] } },
...
} as unknown as DocumentNode<AddFriendMutation, AddFriendMutationVariables>;
export const GetFriendRequestsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getFriendRequests" },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
...
} as unknown as DocumentNode<GetFriendRequestsQuery, GetFriendRequestsQueryVariables>;
    ...
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getPeopleMightKnow" },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
...
} as unknown as DocumentNode<GetPeopleMightKnowQuery, GetPeopleMightKnowQueryVariables>;
    ...
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getUserFriends" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "username" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "getUserFriends" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "username" }, value: { kind: "Variable", name: { kind: "Name", value: "username" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GetUserFriendsQuery, GetUserFriendsQueryVariables>;
export const GetUserMutualsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getUserMutuals" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "username" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
...
} as unknown as DocumentNode<GetUserMutualsQuery, GetUserMutualsQueryVariables>;
export const RejectFriendDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "rejectFriend" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "friend" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "rejectFriend" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "friend" }, value: { kind: "Variable", name: { kind: "Name", value: "friend" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "accepted" } }] } }] },
        },
    ],
} as unknown as DocumentNode<RejectFriendMutation, RejectFriendMutationVariables>;
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "groupId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "userId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
            ],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        ...
                        selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "approved" } }] },
                    },
                ],
            },
        },
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "group" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "NewGroup" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "createGroup" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "group" }, value: { kind: "Variable", name: { kind: "Name", value: "group" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
                                ...
                                { kind: "Field", name: { kind: "Name", value: "chat" }, selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "id" } }] } },
                            ],
                        },
                    },
                ],
    ...
    definitions: [
        {
            ...
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "deleteFile" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "fileId" }, value: { kind: "Variable", name: { kind: "Name", value: "id" } } }] }] },
        },
    ],
} as unknown as DocumentNode<DeleteFileMutation, DeleteFileMutationVariables>;
export const DenyMemberDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "denyMember" },
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "groupId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "userId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
            ],
...
} as unknown as DocumentNode<DenyMemberMutation, DenyMemberMutationVariables>;
...
export const GetGroupFilesDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getGroupFiles" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "getGroupFiles" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "groupId" }, value: { kind: "Variable", name: { kind: "Name", value: "id" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GetGroupFilesQuery, GetGroupFilesQueryVariables>;
    ...
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getGroupHomePosts" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "pagination" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "Pagination" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "getGroupHomePosts" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "pagination" }, value: { kind: "Variable", name: { kind: "Name", value: "pagination" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GetGroupHomePostsQuery, GetGroupHomePostsQueryVariables>;
export const GetGroupInviteDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getGroupInvite" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
...
} as unknown as DocumentNode<GetGroupInviteQuery, GetGroupInviteQueryVariables>;
export const GetGroupPostsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getGroupPosts" },
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "group" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "pagination" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "Pagination" } } } },
            ],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        ...
                        name: { kind: "Name", value: "getGroupPosts" },
                        arguments: [
                            { kind: "Argument", name: { kind: "Name", value: "groupId" }, value: { kind: "Variable", name: { kind: "Name", value: "group" } } },
                            { kind: "Argument", name: { kind: "Name", value: "pagination" }, value: { kind: "Variable", name: { kind: "Name", value: "pagination" } } },
                        ],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
...
} as unknown as DocumentNode<GetGroupPostsQuery, GetGroupPostsQueryVariables>;
...
export const GetJoinRequestsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
...
} as unknown as DocumentNode<GetJoinRequestsQuery, GetJoinRequestsQueryVariables>;
export const GetJoinedGroupsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getJoinedGroups" },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
...
} as unknown as DocumentNode<GetJoinedGroupsQuery, GetJoinedGroupsQueryVariables>;
export const HandleRequestDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "handleRequest" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
...
} as unknown as DocumentNode<HandleRequestMutation, HandleRequestMutationVariables>;
export const InviteToGroupDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "inviteToGroup" },
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "groupId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "userId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
            ],
...
} as unknown as DocumentNode<InviteToGroupMutation, InviteToGroupMutationVariables>;
export const KickMemberDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "kickMember" },
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "groupId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "userId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
            ],
...
} as unknown as DocumentNode<KickMemberMutation, KickMemberMutationVariables>;
export const PromoteMemberDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "promoteMember" },
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "groupId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "userId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
            ],
...
} as unknown as DocumentNode<PromoteMemberMutation, PromoteMemberMutationVariables>;
export const UpdateGroupBackgroundDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            ...
            variableDefinitions: [
                ...
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "background" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } },
            ],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        ...
                        arguments: [
                            ...
                            { kind: "Argument", name: { kind: "Name", value: "background" }, value: { kind: "Variable", name: { kind: "Name", value: "background" } } },
                        ],
                        selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "background" } }] },
                    },
                ],
            },
        },
    ],
} as unknown as DocumentNode<UpdateGroupBackgroundMutation, UpdateGroupBackgroundMutationVariables>;
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "file" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "NewGroupFile" } } } },
            ],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        ...
                        arguments: [
                            { kind: "Argument", name: { kind: "Name", value: "groupId" }, value: { kind: "Variable", name: { kind: "Name", value: "id" } } },
                            { kind: "Argument", name: { kind: "Name", value: "file" }, value: { kind: "Variable", name: { kind: "Name", value: "file" } } },
                        ],
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "username" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "createConversation" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "username" }, value: { kind: "Variable", name: { kind: "Name", value: "username" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "id" } }] } }] },
        },
    ],
                ...
                selections: [
                    {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                ...
                                { kind: "Field", name: { kind: "Name", value: "messages" }, selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "message" } }] } },
                            ],
                        },
                    },
                ],
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "convID" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "message" } }, type: { kind: "NamedType", name: { kind: "Name", value: "String" } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "image" } }, type: { kind: "NamedType", name: { kind: "Name", value: "String" } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "post" } }, type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } },
            ],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        ...
                        name: { kind: "Name", value: "sendMessage" },
                        arguments: [
                            { kind: "Argument", name: { kind: "Name", value: "conversationID" }, value: { kind: "Variable", name: { kind: "Name", value: "convID" } } },
                            { kind: "Argument", name: { kind: "Name", value: "message" }, value: { kind: "Variable", name: { kind: "Name", value: "message" } } },
                            { kind: "Argument", name: { kind: "Name", value: "image" }, value: { kind: "Variable", name: { kind: "Name", value: "image" } } },
                            { kind: "Argument", name: { kind: "Name", value: "postID" }, value: { kind: "Variable", name: { kind: "Name", value: "post" } } },
                        ],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
...
export const ViewConversationDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "subscription",
            name: { kind: "Name", value: "viewConversation" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "conversation" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "viewConversation" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "conversationID" }, value: { kind: "Variable", name: { kind: "Name", value: "conversation" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                {
...
} as unknown as DocumentNode<ViewConversationSubscription, ViewConversationSubscriptionVariables>;
...
} as unknown as DocumentNode<GetUnreadNotificationsMutation, GetUnreadNotificationsMutationVariables>;
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "newComment" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "NewComment" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "createComment" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "newComment" }, value: { kind: "Variable", name: { kind: "Name", value: "newComment" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "post" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "NewPost" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "createPost" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "newPost" }, value: { kind: "Variable", name: { kind: "Name", value: "post" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
...
export const GetCommentPostDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getCommentPost" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "postId" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "getCommentPost" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "postID" }, value: { kind: "Variable", name: { kind: "Name", value: "postId" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GetCommentPostQuery, GetCommentPostQueryVariables>;
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "likecomment" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "commentID" }, value: { kind: "Variable", name: { kind: "Name", value: "id" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "commentId" } }] } }] },
        },
    ],
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "likePost" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "postID" }, value: { kind: "Variable", name: { kind: "Name", value: "id" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "postId" } }] } }] },
        },
    ],
} as unknown as DocumentNode<LikePostMutation, LikePostMutationVariables>;
export const SharePostDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "sharePost" },
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "user" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "post" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } },
            ],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        ...
                        name: { kind: "Name", value: "sharePost" },
                        arguments: [
                            { kind: "Argument", name: { kind: "Name", value: "userID" }, value: { kind: "Variable", name: { kind: "Name", value: "user" } } },
                            { kind: "Argument", name: { kind: "Name", value: "postID" }, value: { kind: "Variable", name: { kind: "Name", value: "post" } } },
                        ],
                    },
                ],
...
} as unknown as DocumentNode<SharePostMutation, SharePostMutationVariables>;
    ...
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "createReel" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "reel" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "NewReel" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "createReel" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "reel" }, value: { kind: "Variable", name: { kind: "Name", value: "reel" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<CreateReelMutation, CreateReelMutationVariables>;
    ...
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "createReelComment" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "comment" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "NewReelComment" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "createReelComment" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "comment" }, value: { kind: "Variable", name: { kind: "Name", value: "comment" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<CreateReelCommentMutation, CreateReelCommentMutationVariables>;
export const GetReelDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getReel" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
...
} as unknown as DocumentNode<GetReelQuery, GetReelQueryVariables>;
export const GetReelCommentsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getReelComments" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "getReelComments" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "reelId" }, value: { kind: "Variable", name: { kind: "Name", value: "id" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GetReelCommentsQuery, GetReelCommentsQueryVariables>;
...
export const LikeReelDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "likeReel" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "reel" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "likeReel" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "reelId" }, value: { kind: "Variable", name: { kind: "Name", value: "reel" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "reelId" } }] } }] },
        },
    ],
} as unknown as DocumentNode<LikeReelMutation, LikeReelMutationVariables>;
export const LikeReelCommentDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "likeReelComment" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "ID" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "likeReelComment" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "reelCommentId" }, value: { kind: "Variable", name: { kind: "Name", value: "id" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "reelCommentId" } }] } }] },
        },
    ],
} as unknown as DocumentNode<LikeReelCommentMutation, LikeReelCommentMutationVariables>;
export const GetFilteredGroupsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getFilteredGroups" },
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "filter" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "pagination" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "Pagination" } } } },
            ],
            selectionSet: {
                kind: "SelectionSet",
...
} as unknown as DocumentNode<GetFilteredGroupsQuery, GetFilteredGroupsQueryVariables>;
export const GetFilteredPostsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getFilteredPosts" },
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "filter" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "pagination" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "Pagination" } } } },
            ],
...
} as unknown as DocumentNode<GetFilteredPostsQuery, GetFilteredPostsQueryVariables>;
    ...
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "getFilteredUsers" },
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "filter" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "pagination" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "Pagination" } } } },
            ],
                ...
                selections: [
                    {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                ...
                                { kind: "Field", name: { kind: "Name", value: "username" } },
                                { kind: "Field", name: { kind: "Name", value: "profile" } },
                                { kind: "Field", name: { kind: "Name", value: "friended" } },
                            ],
                        },
                    },
                ],
...
} as unknown as DocumentNode<GetFilteredUsersQuery, GetFilteredUsersQueryVariables>;
    ...
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "createImageStory" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "story" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "NewImageStory" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "createImageStory" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "input" }, value: { kind: "Variable", name: { kind: "Name", value: "story" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<CreateImageStoryMutation, CreateImageStoryMutationVariables>;
export const CreateTextStoryDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "createTextStory" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "story" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "NewTextStory" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
...
} as unknown as DocumentNode<CreateTextStoryMutation, CreateTextStoryMutationVariables>;
...
export const GetUserWithStoriesDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetUserWithStories" },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
...
} as unknown as DocumentNode<GetUserWithStoriesQuery, GetUserWithStoriesQueryVariables>;
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "activateUser" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "id" }, value: { kind: "Variable", name: { kind: "Name", value: "id" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "id" } }] } }] },
        },
    ],
} as unknown as DocumentNode<ActivateUserMutation, ActivateUserMutationVariables>;
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "email" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "password" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } },
            ],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
...
export const CheckActivateLinkDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "checkActivateLink" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "checkActivateLink" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "id" }, value: { kind: "Variable", name: { kind: "Name", value: "id" } } }] }] },
        },
    ],
} as unknown as DocumentNode<CheckActivateLinkQuery, CheckActivateLinkQueryVariables>;
    ...
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "checkResetLink" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "checkResetLink" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "id" }, value: { kind: "Variable", name: { kind: "Name", value: "id" } } }] }] },
        },
    ],
} as unknown as DocumentNode<CheckResetLinkQuery, CheckResetLinkQueryVariables>;
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "user" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "NewUser" } } } }],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "createUser" },
                        arguments: [{ kind: "Argument", name: { kind: "Name", value: "input" }, value: { kind: "Variable", name: { kind: "Name", value: "user" } } }],
                        selectionSet: {
                            kind: "SelectionSet",
                            selections: [
                                { kind: "Field", name: { kind: "Name", value: "id" } },
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "email" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "forgotPassword" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "email" }, value: { kind: "Variable", name: { kind: "Name", value: "email" } } }] }] },
        },
    ],
                ...
                selections: [
                    {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                ...
                                { kind: "Field", name: { kind: "Name", value: "background" } },
                                { kind: "Field", name: { kind: "Name", value: "friended" } },
                                { kind: "Field", name: { kind: "Name", value: "friendCount" } },
                                { kind: "Field", name: { kind: "Name", value: "mutualCount" } },
                                {
                                    kind: "Field",
                                    name: { kind: "Name", value: "posts" },
                                    selectionSet: {
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "id" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } },
                { kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "password" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } },
            ],
            selectionSet: {
                kind: "SelectionSet",
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "updateUser" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "UpdateUser" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "updateUser" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "input" }, value: { kind: "Variable", name: { kind: "Name", value: "updateUser" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "id" } }] } }] },
        },
    ],
} as unknown as DocumentNode<UpdateUserMutation, UpdateUserMutationVariables>;
export const UpdateUserBackgroundDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "updateUserBackground" },
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "background" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "updateUserBackground" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "background" }, value: { kind: "Variable", name: { kind: "Name", value: "background" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "id" } }] } }] },
        },
    ],
} as unknown as DocumentNode<UpdateUserBackgroundMutation, UpdateUserBackgroundMutationVariables>;
    ...
    definitions: [
        {
            ...
            variableDefinitions: [{ kind: "VariableDefinition", variable: { kind: "Variable", name: { kind: "Name", value: "profile" } }, type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "String" } } } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "updateUserProfile" }, arguments: [{ kind: "Argument", name: { kind: "Name", value: "profile" }, value: { kind: "Variable", name: { kind: "Name", value: "profile" } } }], selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "id" } }] } }] },
        },
    ],
