...
export type GetReelQuery = { __typename?: 'Query', getReel: { __typename?: 'Reel', id: string, content: string, video: string, user: { __typename?: 'User', id: string, firstName: string, lastName: string, username: string } } };
