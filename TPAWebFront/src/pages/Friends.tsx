                    ...
                    <Sidebar title={"Friends"}>
                        <>
                            <div
                                onClick={() => setTab("all")}
                            >
                                <SidebarButton active={tab == "all"} text={"All"}>
                                    <FaUserFriends
                                        color={"black"}
                                        size={"1.5rem"}
                                    />
                            ...
                            >
                                <SidebarButton active={tab == "request"} text={"Requests"}>
                            ...
                            >
                                <SidebarButton active={tab == "reccomendation"} text={"Recommendation"}>
                            ...
                            >
                                <SidebarButton active={tab == "friend"} text={"All Friends"}>
                                    <BsFillPersonFill
                                        color={"black"}
                                        size={"1.5rem"}
                                    />
